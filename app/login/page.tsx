...
//           <h2 className="text-3xl font-extrabold text-white mb-4 text-center">Login</h2>
...
// import { GlobalContext } from '../context/GlobalProvider'; // adjust the path accordingly
...
const Login = () => {
  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      ...
      if (user) {
        console.log(user , 'namasteeeeeeeeeeeeeeee');
